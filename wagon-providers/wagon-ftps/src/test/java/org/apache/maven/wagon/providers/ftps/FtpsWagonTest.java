package org.apache.maven.wagon.providers.ftps;
    ...
    extends StreamingWagonTestCase
{
        ...
        throws Exception
    {
        ...
        if (server == null)
        {
            ...
            sslConfigurationFactory.setKeystoreFile(new File("test.jks"));
            sslConfigurationFactory.setKeystorePassword("testtest");
            sslConfigurationFactory.setKeyAlias("test");
            sslConfigurationFactory.setKeyPassword("testtest");

            factory.setSslConfiguration(sslConfigurationFactory.createSslConfiguration());
    ...
    {
        return "ftps://localhost:" + getTestRepositoryPort();
    }
